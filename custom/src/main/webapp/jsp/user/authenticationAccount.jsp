            ...
            <dl>
                <table>
                    ...
                    <dd class="content-file-box  ">
                        ...
                        <br> <br>
                        <input type="file"  name="idCard1" onchange="html5Reader(this,'idCard1')" class="content-file col-lg-3"  placeholder="未完待续">
                        <img  hidden  class=" col-lg-offset-2 " id="idCard1" src="" width="130px" height="80px" >
                    </dd>
                    <dd class="content-file-box">
                        <span class="content-text">身份证反面</span>
                        <br> <br>
                          <input  type="file" name="idCard2"  onchange="html5Reader(this,'idCard2')" class="content-file col-lg-3" placeholder="未完待续"><!--

                             -->
                        <!--<a class="content-link" href="#">保存</a>-->
                        <img hidden  class=" col-lg-offset-2 " id="idCard2" src="" width="130px" height="80px" >
                    </dd>
                    <dd class="content-file-box">

                        <span class="content-text">驾驶证正面</span>
                        <br><br>
                      <input type="file" name="driverCar1"  onchange="html5Reader(this,'driverCar1')" class="content-file col-lg-3" placeholder="未完待续">

                        <img hidden class=" col-lg-offset-2 " id="driverCar1" src="" width="130px" height="80px" >

                    </dd>
                    <dd class="content-file-box">
                        <span class="content-text">驾驶证副页</span>
                        <br> <br>
                            <input type="file" name="driverCar2"  onchange="html5Reader(this,'driverCar2')" class="content-file col-lg-3" placeholder="未完待续"><!--
                             --><!--
                             -->
                        <img hidden  class=" col-lg-offset-2 "  id="driverCar2" src="" width="120px" height="80px" >
                        <!--<a class="content-link" href="#">保存</a>-->
                    </dd>
                    <button  type="submit" class="btn-info btn-sm col-lg-offset-6 col-lg-1" >提交</button>
                </table>
            </dl>
        </div>
        </form>
